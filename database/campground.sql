...
CREATE TABLE reservation (
  ...
  name varChar(80) NOT NULL,                  -- Name on the reservation
  start_date date NOT NULL,                    -- Reservation starting date
  num_days int NOT NULL,                      -- Length of the reservation in days
  create_date date NOT NULL DEFAULT now(),    -- Date reservation was made
...
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (1, 'Smith Family Reservation', NOW() - INTERVAL '2 days', 2);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (1, 'Lockhart Family Reservation', NOW() - INTERVAL '6 days', 3);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (2, 'Jones Reservation', NOW() - INTERVAL '2 days', 2);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (3, 'Bauer Family Reservation', NOW(), 2);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (4, 'Eagles Family Reservation', NOW() + INTERVAL '5 days', 10);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (7, 'Aersomith eservation', NOW() - INTERVAL '3 days', 2);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (9, 'Claus Family Reservation', NOW(), 1);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (9, 'Taylor Family Reservation', NOW() - INTERVAL '7 days', 2);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (10, 'Astley Family Reservation', NOW() + INTERVAL '14 days', 7);

-- Acadia Seawall Sites (13 - 24)
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (13, 'Jobs Family Reservation', NOW() + INTERVAL '1 days', 4);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (14, 'Cook Family Reservation', NOW() + INTERVAL '1 days', 3);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (15, 'Gates Reservation', NOW() + INTERVAL '1 days', 3);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (16, 'Cue Family Reservation', NOW() + INTERVAL '1 days', 3);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (17, 'Ive Family Reservation', NOW() + INTERVAL '1 days', 3);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (18, 'Federighi Family Reservation', NOW() + INTERVAL '1 days', 3);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (19, 'Schiller Family Reservation', NOW() + INTERVAL '1 days', 3);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (20, 'Williams Family Reservation', NOW() + INTERVAL '1 days', 3);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (20, 'Kawasaki Family Reservation', NOW() + INTERVAL '10 days', 11);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (20, 'Branson Family Reservation', NOW() + INTERVAL '22 days', 6);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (20, 'Zukerberg Family Reservation', NOW() + INTERVAL '30 days', 3);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (24, 'Musk Family Reservation', NOW() + INTERVAL '4 days', 6);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (24, 'Buffett Family Reservation', NOW() - INTERVAL '4 days', 4);

-- Acadia Schoodic Woods Sites (25 - 36)
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (25, 'Satya Nedella', NOW() + INTERVAL '3 days', 7);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (25, 'Scott Gutherie', NOW() + INTERVAL '10 days', 4);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (28, 'Amy Hood', NOW() + INTERVAL '5 days', 6);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (29, 'Peggy Johnson', NOW() + INTERVAL '5 days', 6);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (31, 'Terry Myerson', NOW() + INTERVAL '9 days', 2);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (32, 'Steve Ballmer', NOW() + INTERVAL '13 days', 2);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (32, 'Gates Family Reservation', NOW() + INTERVAL '16 days', 3);

-- Devil's Garden (37 - 44)
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (37, 'Marisa Mayer', NOW() - INTERVAL '15 days', 5);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (37, 'Beth Mooney', NOW(), 4);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (40, 'William Priemer', NOW() + INTERVAL '2 days', 4);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (42, 'Tricia Griffith', NOW() + INTERVAL '3 days', 5);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (43, 'Toby Cosgrove', NOW() + INTERVAL '5 days', 6);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (43, 'Akram Boutros', NOW() + INTERVAL '12 days', 6);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (44, 'Barbara Snyder', NOW() + INTERVAL '9 days', 2);

-- Canyon Wren (45)
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (45, 'Bill Board', NOW() - INTERVAL '9 days', 10);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (45, 'Bill Loney', NOW() + INTERVAL '1 days', 10);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (45, 'Cara Van', NOW() + INTERVAL '17 days', 4);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (45, 'Forrest Gump', NOW() + INTERVAL '31 days',6);

-- Juniper Group Site (46)
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (46, 'Simpson Family', NOW() - INTERVAL '6 days', 7);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (46, 'Smith Family', NOW() + INTERVAL '2 days', 9);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (46, 'Leela Family', NOW() + INTERVAL '14 days', 1);
INSERT INTO reservation (site_id, name, start_date, num_days) VALUES (46, 'Scott Family', NOW() + INTERVAL '35 days',5);
